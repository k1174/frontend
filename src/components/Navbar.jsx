...
export default function Navbar() {
    ...
    const handleLogout = async () => {
        try {
            ...
            // Remove the cookie (you might need to do this via backend call if the cookie is httpOnly)
    
     
        
    
            // Refresh the page after the toast
            setTimeout(() => {
                window.location.reload();  // This will refresh the page
            }, 2000);  // Refresh after 2 seconds, after the toast notification
        } catch (error) {
