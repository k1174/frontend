...
import { getUserProfile, getUserRegistrations, getUserCreatedEvents } from '../../api';
        ...
        const fetchUser = async () => {
            ...
            if (!token) {
                ...
                try {
                    ...
                    const userCreatedEvents = await getUserCreatedEvents(userProfile._id)
        ...
        <>
            <>
                <div className='bg-blue-50'>
                    ...
                    <div className="gap-6 flex items-center justify-center pt-2 ">
                        <div
                            className="  relative  overflow-hidden hover:shadow-2xl group rounded-xl pr-2 pt-2 transition-all duration-500 transform">
                            <div className="flex items-center gap-4">
                                <FiUser
                                    className="w-20 group-hover:w-36 group-hover:h-36 h-32 object-center object-cover rounded-full transition-all duration-500 delay-500 transform"
                                />
                                ...
                                <div className="w-fit transition-all transform duration-500  ">
                                    ...
                                    <p className="text-gray-400"><span className="bg-blue-100 text-blue-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded">{user.role}</span></p>
                                    <a
